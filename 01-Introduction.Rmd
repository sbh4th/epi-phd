...
g <- ganttAddTask(g, "Epi Methods I", "2021-09-01", "2021-12-15")
g <- ganttAddTask(g, "Study Design", "2021-09-01", "2021-12-15")
g <- ganttAddTask(g, "Epi Methods II", "2022-01-01", "2022-04-15")
g <- ganttAddTask(g, "PhD Seminar", "2022-01-01", "2022-04-15")
g <- ganttAddTask(g, "Comprehensive Exam", "2022-06-01", "2022-06-08")
g <- ganttAddTask(g, "Thesis Protocol", "2022-09-01", "2023-04-15")
g <- ganttAddTask(g, "BIOS Electives", "2022-09-01", "2023-04-15")
g <- ganttAddTask(g, "EPIB Electives", "2022-09-01", "2023-04-15")
g <- ganttAddTask(g, " ", start=NA, end=NA)
g <- ganttAddTask(g, "Research") # no times, so a heading
g <- ganttAddTask(g, "Literature review", "2021-09-01", "2023-04-15")
g <- ganttAddTask(g, "Supervisor nomination", "2022-05-15", "2022-05-29")
g <- ganttAddTask(g, "Tracking form", "2023-05-15", "2023-05-29")
g <- ganttAddTask(g, "Defend thesis proposal", "2023-01-01", "2023-04-15")
g <- ganttAddTask(g, "Thesis work", "2023-04-15", "2025-04-15")
g <- ganttAddTask(g, "Tracking form", "2024-05-15", "2024-05-29")
g <- ganttAddTask(g, "Teaching assistantship", "2024-09-01", "2024-12-15")
g <- ganttAddTask(g, "Tracking form", "2025-05-15", "2025-05-29")
g <- ganttAddTask(g, "Defend thesis", "2025-06-01", "2025-06-15")
g <- ganttAddTask(g, " ", start=NA, end=NA)
font <- ifelse(is.na(g[["start"]]), 2, 1)
plot(g, ylabel=list(font=font),
     event.time="2021-09-01", event.label="2021-2022 Cohort\n")
